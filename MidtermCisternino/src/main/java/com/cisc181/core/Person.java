...
public abstract class Person {
	...
	public void setDOB(Date DOB) throws PersonException {
		...
		compareDate.set(today.get(Calendar.YEAR) - 100, today.get(Calendar.MONTH), today.get(Calendar.DATE));
		BirthDate.setTime(DOB);
		if(BirthDate.compareTo(compareDate) < 0) {
			throw new PersonException(this, "Invalid Date of Birth");
		}
	...
	public void setPhone(String newPhone_number) throws PersonException {
		...
		if (newPhone_number.matches(regex) == false) {
			throw new PersonException (this, "Invalid Number Format");
		}
